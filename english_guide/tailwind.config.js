...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      maxHeight: {
        ...
        450: "450px",
        heightImg:
          "calc(100vh - (24px + 24px + 4px + 4px + 8px + (48px + 20px + 12px)))",
      },
      maxWidth: {
        370: "370px",
        widthImg: "calc(100vw)",
      ...
      boxShadow: {
        primary:
          "inset 0 1px 0 hsl(0deg 0% 100% / 15%), 0 1px 1px rgb(17 24 39 / 8%)",
        ...
        strong89dwn:
          "rgb(0 0 0 / 40%) 0px 0px 4px, rgb(0 0 0 / 30%) 0px 0px 4px -3px, rgb(0 0 0 / 20%) 0px 3px 0px inset",
      },
      borderWidth: {
        default: "0.0625rem",
      },
  ...
  plugins: [
    plugin(function ({ addUtilities }) {
      const newUtilities = {
        ".backdrop-blur-hue": {
          "backdrop-filter": "blur(20px) hue-rotate(230deg)",
        },
      };
